function SliderTestimonial(configuration) {
  const plugin = this;
...
SliderTestimonial.prototype.getActiveSlideIndex = function() {
  const plugin = this;
  return plugin.slides.indexOf(plugin.slides.filter(slide => slide.classList.contains(plugin.classes.active)).pop());
};
SliderTestimonial.prototype.activeSlide = function(index, direction) {
  const plugin = this;
...
SliderTestimonial.prototype.next = function() {
  const plugin = this;
...
SliderTestimonial.prototype.previous = function() {
  const plugin = this;
  if (plugin.navigationAbility) {
    const currentIndex = plugin.getActiveSlideIndex();
...
SliderTestimonial.prototype.init = function() {
  const plugin = this;
